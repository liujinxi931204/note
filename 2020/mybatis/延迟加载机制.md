...
```  
#### 实验结果  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/10/20/1603185557518-1603185557521.png)  
...
```  
#### 实验结果  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/10/20/1603186209750-1603186209751.png)  
...
```  
#### 实验结果  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/10/20/1603186517806-1603186517808.png)  
...
```  
#### 实验结果  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/10/20/1603186845279-1603186845284.png)  
...
```  
#### 实验结果  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/10/20/1603187175331-1603187175332.png)  
可以看到主查询`select id,name from category`被执行了，关联查询`select id,name,price,cid from product where cid=#{cid}`没有被执行，说明`fetchType=lazy`可以实现该查询的
