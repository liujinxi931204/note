...
### explain  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/explain-1597717551425.png)  
...
#### 理想情况  
全值匹配(索引最佳)和索引顺序无关  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597720706284-1597720706288.png)  
和索引顺序无关，MySQL底层的优化器会进行优化，调整索引顺序  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597720752228-1597720752236.png)  
### 索引失效 
1. 违反最左前缀法则  
如果索引有多列，要遵守最左前缀法则，即查询从索引的最做前列开始并且不跳过索引的中间列  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597720878676-1597720878677.png)  
2. 在索引列上做任何操作  
如在索引列上做计算、函数、（手动或自动）类型转换等操作，都会导致索引失效从而全表扫描  
  ![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597720993191-1597720993192.png)  
3. 索引范围条件右边的列  
索引范围条件右边的索引列会失效  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721046128-1597721046130.png)  
4. 尽量使用覆盖索引  
只访问索引查询(索引列和查询列一致)，减少使用select *  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721126666-1597721126668.png)  
5. 使用不等于(!=,<>)  
MySQL中使用不等于(!=,<>)的时候无法使用索引会导致全表扫描(覆盖索引除外)  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721262389-1597721262390.png)  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721275419-1597721275421.png)  
6. like以通配符开头('%abc')
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721342493-1597721342494.png)  
索引生效  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721799423-1597721799424.png)
7. 字符串不加单引号索引失效  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721490597-1597721490598.png)
8. or连接  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721559009-1597721559010.png)  
9. oder by违反最左前缀法则、含非索引字段排序，会导致文件排序  
额外的文件排序会降低性能  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721689757-1597721689766.png)  
10. group by违反最左前缀法则、含非索引字段分组，会导致产生临时表  
产生临时表会降低性能  
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/08/18/1597721741948-1597721741949.png)  
### 最左前缀原理与相关优化  
