...
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/09/14/1600069670857-1600069670858.png)  
...
下标参数start和stop都以0为底，超出范围的下标并不会引起错误。当start的值比有序集合的最大下标还有大或者start>stop时，会返回一个空列表；如果stop参数的值超过了有序集合最大下标，那么redis将stop
