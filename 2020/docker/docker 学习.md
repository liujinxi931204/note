...
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/05/27/1590544671972-1590544672011.png)  
### CNM  
docker网络架构的设计规范是CNM  
...
节点会被配置为管理节点(manager)或者工作节点(worker).管理节点负责集群控制面(control plane)，进行诸如监控集群状态、分发任务只工作节点等操作。工作节点接收来自管理节点的任务并执行    
...
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/06/02/1591070293495-1591070293496.png)  
...
![title](https://raw.githubusercontent.com/liujinxi931204/image/master/gitnote/2020/06/02/1591079557481-1591079557482.png)  
关于HA，有以下两条最佳实践  
1.部署奇数个管理节点  
2.不要部署太多管理节点(3个或5个)  
## 内置swarm安全机制  
...
通过上面的命令，可以看出，`docker service create`命令告知docker正在声明一个新服务，并传递--name参数将其命名为web-fe,将每个节点上的8080端口映射到服务副本内部的8080端口，接下来，使用--replicas
