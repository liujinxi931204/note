...
### Collection接口继承树  
![title](https://gitee.com/liujinxi931204/image/raw/master/gitnote/2020/10/30/1604067881236-1604067881244.png)   
### Map接口继承树  
![title](https://gitee.com/liujinxi931204/image/raw/master/gitnote/2020/10/30/1604067906211-1604067906216.png)  
### Collection接口中的方法的使用  
1. 添加  
+ add(E e)  
+ addAll(E e)
...
### LinkedHashSet  
LinkedHashSet继承自HashSet，使用迭代器遍历的时候，回按照插入元素的顺序显示元素  
### TreeSet  
TreeSet使用元素的自然顺序对元素进行排序，或者在创建TreeSet时按照指定的Comparator进行排序  
### Map接口  
